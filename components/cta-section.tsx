...
// Tambahkan definisi props agar bisa menerima fungsi dari page.tsx
...
export function CTASection({ onClick }: CTASectionProps) {
  ...
  const handleClick = () => {
    ...
    // Jalankan efek bawaan (hati confetti)
    fireHearts();

    // Jalankan efek baru (LoveBackground & visual mercon) dari page.tsx
    if (onClick) {
      onClick();
    }
  };
